    ...
    <div class="titlebar flex items-center justify-between select-none" style="height:40px;-webkit-app-region:drag">
      ...
      <div class="flex items-center" style="-webkit-app-region:no-drag">
        ...
        <div class="flex items-center gap-1.5 px-3 text-xs">
          ...
          <span class="text-gray-600">v0.2.11</span>
        </div>
        <!-- Window controls -->
...
const i18n = {
  zh: {
    ...
    assign_model: '指定模型', assign_model_hint: '一旦选择，该用户发送的 llm 请求无论指定什么模型，都使用该模型通讯。', assign_clear: '清除指定',
 ...
 stats_all_users: '全部用户', db_volume: '数据库体积',
  ...
  en: {
    ...
    assign_model: 'Assign Model', assign_model_hint: "Once set, this user's llm requests will use the assigned model regardless of the requested model.", assign_clear: 'Clear Assignment',
 ...
 stats_all_users: 'All Users', db_volume: 'DB Volume',
  ...
  ja: {
    ...
    assign_model: 'モデル指定', assign_model_hint: '設定すると、このユーザーの llm リクエストは指定されたモデルで通信します（要求モデルとは無関係）。', assign_clear: '指定解除',
