...
const i18n = {
  zh: {
    ...
    fld_name: '名称', fld_name_hint: '⚠ 不能包含空格或下划线', fld_name_dup: '已存在同名供应商', fld_protocol: '协议', fld_base_url: 'API Base URL', fld_api_key: 'API Key',
    ...
    assign_model: '指定模型', assign_model_hint: '一旦选择，该用户发送的 llm 请求无论指定什么模型，都使用该模型通讯。', assign_model_v2_hint: '只能从该 API Key 已授权的模型中选择。', assign_clear: '清除指定', assign_no_authorized: '该 Key 尚未授权任何模型，请先在编辑中授权。',
    ...
    btn_select_all: '全选', btn_select_none: '取消全选',
    auth_count_label: '个模型已授权', auth_selected_label: '个已选',
 ...
 stats_all_users: '全部用户', db_volume: '数据库体积',
  ...
  en: {
    ...
    fld_name: 'Name', fld_name_hint: '⚠ No spaces or underscores allowed', fld_name_dup: 'A provider with this name already exists', fld_protocol: 'Protocol', fld_base_url: 'API Base URL', fld_api_key: 'API Key',
    ...
    assign_model: 'Assign Model', assign_model_hint: "Once set, this user's llm requests will use the assigned model regardless of the requested model.", assign_model_v2_hint: 'Only models already authorized for this key can be assigned.', assign_clear: 'Clear Assignment', assign_no_authorized: 'This key has no authorized models yet. Edit the key to grant access first.',
    ...
    btn_select_all: 'Select All', btn_select_none: 'Clear All',
    auth_count_label: ' models authorized', auth_selected_label: ' selected',
 ...
 stats_all_users: 'All Users', db_volume: 'DB Volume',
  ...
  ja: {
    ...
    fld_name: '名称', fld_name_hint: '⚠ スペース・アンダースコア不可', fld_name_dup: '同名のプロバイダーが既に存在します', fld_protocol: 'プロトコル', fld_base_url: 'API Base URL', fld_api_key: 'API Key',
    ...
    assign_model: 'モデル指定', assign_model_hint: '設定すると、このユーザーの llm リクエストは指定されたモデルで通信します（要求モデルとは無関係）。', assign_model_v2_hint: 'このキーに既に認可されたモデルからのみ選択できます。', assign_clear: '指定解除', assign_no_authorized: 'このキーには認可されたモデルがありません。先に編集から認可してください。',
    ...
    btn_select_all: '全て選択', btn_select_none: '選択解除',
    auth_count_label: ' 件認可済', auth_selected_label: ' 件選択中',
